...
class SysDb(DbSql):
    表结构 = {
        'websiteTabel': {
            ...
            '搜索起始日期年': {'类型': '整型', '初始值': None, '主键否': '非主键'},
            '搜索起始日期月': {'类型': '整型', '初始值': None, '主键否': '非主键'},
            '搜索起始日期日': {'类型': '整型', '初始值': None, '主键否': '非主键'},
            '搜索终止日期年': {'类型': '整型', '初始值': None, '主键否': '非主键'},
            '搜索终止日期月': {'类型': '整型', '初始值': None, '主键否': '非主键'},
            '搜索终止日期日': {'类型': '整型', '初始值': None, '主键否': '非主键'},
